...
mongoose.connect(
"mongodb+srv://lingojikarthikchary:I6d1dmcd7Bq8t9Vc@cluster0.p7kft.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"  );
...
app.post('/candidates',  async (req, res) => {
  const { name, position, area,image } = req.body;
